        ...
        <div class="flex justify-between items-center h-16">
            ...
            <div class="flex items-center space-x-4 space-x-reverse">
                ...
                @if(Auth::user()->hasRole('owner'))
                    ...
                    @else
                        <div class="flex items-center space-x-2 space-x-reverse px-3 py-1.5 bg-gray-50 border border-gray-200 rounded-lg">
                ...
                <div class="relative" x-data="{ open: false }">
                    <button 
                        type="button"
                        @click="open = !open"
                        class="flex items-center space-x-2 space-x-reverse p-2 text-gray-600 hover:text-gray-900 hover:bg-gray-100 rounded-full transition-colors duration-200"
                        title="الملف الشخصي"
                    >
