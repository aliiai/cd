...
<div class="py-12">
    <div class="w-full mx-auto sm:px-6 lg:px-8 max-w-5xl">
        ...
        <div class="bg-white rounded-xl shadow-xl border border-gray-200 overflow-hidden mb-6">
            ...
            <div class="p-6">
                <div class="grid grid-cols-1 md:grid-cols-4 gap-4">
                    <div>
                        <p class="text-sm font-medium text-gray-600 mb-1">المستخدم</p>
        ...
        <div class="bg-white rounded-xl shadow-xl border border-gray-200 overflow-hidden mb-6">
            <div class="p-6">
                <form action="{{ route('admin.tickets.update-status', $ticket) }}" method="POST" class="flex items-center gap-4">
                    @csrf
        ...
        <div class="bg-white rounded-xl shadow-xl border border-gray-200 overflow-hidden mb-6">
            ...
            <div class="p-6">
                ...
                @if($ticket->status !== 'closed')
                    <form action="{{ route('admin.tickets.reply', $ticket) }}" method="POST" enctype="multipart/form-data" class="border-t pt-4">
                        @csrf
                        <div class="mb-4">
