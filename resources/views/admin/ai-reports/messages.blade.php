...
<div class="min-h-screen bg-gradient-to-br from-slate-50 via-primary-50 to-secondary-50 dark:from-gray-900 dark:via-gray-800 dark:to-gray-900 py-12">
    <div class="w-full mx-auto sm:px-6 lg:px-8">
        ...
        <div class="mb-8">
            ...
            <h1 class="text-4xl font-bold text-gray-900 dark:text-gray-100 mb-2">تقارير الرسائل</h1>
            <p class="text-lg text-gray-600 dark:text-gray-400">عرض شامل لجميع الرسائل المرسلة - مرجع رسمي للنزاعات والمراجعات القانونية</p>
        </div>
        ...
        <div class="bg-white dark:bg-gray-800 rounded-xl shadow-lg border border-gray-200 dark:border-gray-700 overflow-hidden">
            <div class="bg-gradient-to-r from-primary-600 to-secondary-600 dark:from-primary-700 dark:to-secondary-700 px-6 py-4">
                <h2 class="text-xl font-bold text-white">قائمة الرسائل</h2>
            </div>
                ...
                <table class="w-full divide-y divide-gray-200 dark:divide-gray-700">
                    <thead class="bg-gray-50 dark:bg-gray-700/50">
                        <tr>
                            ...
                            <th class="px-6 py-4 text-right text-xs font-bold text-gray-700 dark:text-gray-300 uppercase tracking-wider">المستلم</th>
                            <th class="px-6 py-4 text-right text-xs font-bold text-gray-700 dark:text-gray-300 uppercase tracking-wider">قناة الإرسال</th>
                            <th class="px-6 py-4 text-right text-xs font-bold text-gray-700 dark:text-gray-300 uppercase tracking-wider">نص الرسالة</th>
                            <th class="px-6 py-4 text-right text-xs font-bold text-gray-700 dark:text-gray-300 uppercase tracking-wider">وقت الإرسال</th>
                            <th class="px-6 py-4 text-right text-xs font-bold text-gray-700 dark:text-gray-300 uppercase tracking-wider">حالة الإرسال</th>
                        </tr>
                    </thead>
