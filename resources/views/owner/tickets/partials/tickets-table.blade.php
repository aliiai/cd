    ...
    <div class="overflow-x-auto rounded-lg">
        <table class="w-full divide-y divide-gray-200 dark:divide-gray-700">
            <thead class="bg-gradient-to-r from-primary-500 to-secondary-500">
                <tr>
                    <th class="px-6 py-4 text-right text-xs font-semibold text-white uppercase tracking-wider">رقم الشكوى</th>
                    <th class="px-6 py-4 text-right text-xs font-semibold text-white uppercase tracking-wider">العنوان</th>
                    ...
                    <th class="px-6 py-4 text-right text-xs font-semibold text-white uppercase tracking-wider">آخر رد</th>
                    <th class="px-6 py-4 text-right text-xs font-semibold text-white uppercase tracking-wider">تاريخ الإنشاء</th>
...
@else
    <div class="text-center py-12">
        ...
        <p class="text-gray-500 dark:text-gray-400 font-medium text-lg mb-4">لا توجد شكاوى حالياً.</p>
