...
<div class="min-h-screen bg-gradient-to-br from-slate-50 via-primary-50 to-secondary-50 dark:from-gray-900 dark:via-gray-800 dark:to-gray-900">
    <div class="w-full mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <div class="mb-8 flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
            <div>
                <h1 class="text-2xl sm:text-3xl lg:text-4xl font-bold text-gray-900 dark:text-gray-100 mb-2">تقرير حالات الديون</h1>
                <p class="text-sm sm:text-base lg:text-lg text-gray-600 dark:text-gray-400">عرض توزيع المديونين حسب الحالة مع إجمالي المبلغ</p>
            </div>
            <div>
                <a href="{{ route('owner.reports.debt-status.export') }}" 
