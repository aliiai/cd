...
<body>
    ...
    <table>
        ...
        <tbody>
            ...
            <tr>
                <td style="text-align: right;">{{ $message->client_name }}</td>
                <td style="text-align: right;">{{ $message->client_phone }}</td>
                <td style="text-align: center;">{{ $message->channel == 'sms' ? 'SMS' : 'Email' }}</td>
                <td style="text-align: center;">{{ $message->status == 'sent' ? 'نجح' : 'فشل' }}</td>
                <td style="text-align: right;">{{ \Carbon\Carbon::parse($message->sent_at ?? $message->created_at)->format('Y-m-d H:i') }}</td>
            </tr>
            @endforeach
        </tbody>
    </table>
