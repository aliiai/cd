...
<div class="min-h-screen bg-gradient-to-br from-slate-50 via-primary-50 to-secondary-50 dark:from-gray-900 dark:via-gray-800 dark:to-gray-900">
    <div class="w-full mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        {{-- ========== Header Section ========== --}}
        <div class="mb-8">
            <h1 class="text-4xl font-bold text-gray-900 dark:text-gray-100 mb-2">تقرير الاشتراك والاستهلاك</h1>
            <p class="text-lg text-gray-600 dark:text-gray-400">معلومات الاشتراك الحالي ومؤشرات الاستهلاك</p>
        </div>
